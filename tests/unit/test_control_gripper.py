...
from tools.gripper.control_gripper import create_gripper
from tools.gripper.control_gripper import execute_action
from tools.gripper.control_gripper import main
from tools.gripper.control_gripper import parse_args
from tools.gripper.control_gripper import prompt_menu
...
class ControlGripperTest(absltest.TestCase):
  ...
  def test_main_mock_action_success(self, mock_execute):
    ...
    self.assertIsInstance(
        mock_execute.call_args.kwargs["gripper"], MockGripper
    )
