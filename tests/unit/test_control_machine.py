...
from tools.machine.control_machine import execute_action
from tools.machine.control_machine import main
from tools.machine.control_machine import parse_args
from tools.machine.control_machine import prompt_menu
...
class ControlMachineTest(absltest.TestCase):
  ...
  def test_parse_args_defaults(self):
    ...
    self.assertEqual(args.input_block_name, "standard_in")
  ...
  def test_parse_args_custom_values(self):
    ...
    self.assertEqual(args.action, "open_door")
    self.assertTrue(args.mock)
    self.assertEqual(args.device_name, "custom_ur")
    self.assertEqual(args.output_block_name, "configurable_out")
    self.assertEqual(args.input_block_name, "configurable_in")
    self.assertEqual(args.door_open_pin, 12)
    self.assertEqual(args.door_close_pin, 13)
    self.assertEqual(args.vise_open_pin, 14)
    self.assertEqual(args.vise_close_pin, 15)
    self.assertEqual(args.cycle_start_pin, 16)
    self.assertEqual(args.cycle_done_input_pin, 7)
