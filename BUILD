...
load("@ioc//incode/intrinsic_sdk/intrinsic/assets/build_defs:asset.bzl", "intrinsic_asset_instance")
load("@ioc//incode/intrinsic_sdk/intrinsic/config:def.bzl", "intrinsic_solution")
...
intrinsic_solution(
    ...
    assets = [
        "@ioc//incode/intrinsic_sdk/intrinsic/resources/catalog/resourcedata/gripper:robotiq_pinch_gripper_resource_type",
        "@ioc//incode/intrinsic_sdk/intrinsic/resources/catalog/resourcedata/product/building_block",
        "@ioc//incode/intrinsic_sdk/intrinsic/simulation/gazebo/asset:gazebo_simulator_type",
        ...
        "@ioc//incode/intrinsic_sdk/intrinsic/world/skills/create_object:create_object_skill",
